...
train <- fread("ranks/train.csv", select=c("LeadID", "CompanyName", "PhoneNumber", "Contact", "Sale"))
test <- fread("ranks/test.csv", select=c("LeadID", "CompanyName", "PhoneNumber", "Contact", "Sale"))
